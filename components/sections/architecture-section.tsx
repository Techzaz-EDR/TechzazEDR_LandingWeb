...
export function ArchitectureSection() {
    return (
        <section id="architecture" className="py-10 md:py-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        {components.map((component, index) => (
                            <div
                                key={index}
                                className="p-6 rounded-xl bg-card border border-border hover:border-primary hover:shadow-[inset_0_0_0_1px_rgb(94,27,181),0_0_30px_-10px_rgba(94,27,181,0.5)] transition-all duration-300 text-center group overflow-hidden"
                            >
